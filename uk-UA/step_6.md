<h2 class="c-project-heading--task">Додайте стилю своїй змії</h2>

\--- task ---

Додайте очі, кольори або прикраси, щоб персоналізувати свою змію.

\--- /task ---

<h2 class="c-project-heading--explainer">Make it yours</h2>

Ваша змія ковзає — тепер час надати їй вайбу!

Ви можете:

- Додайте білі очі з чорними зіницями
- Змінити колір тіла або кожного круга
- Додайте смужки, язик або навіть святковий капелюх!
